        ...
        <div class="container">
            ...
            <div class="weather-details__basic">
                <div class="weather-details__current">
                    <img src="../assets/images/1.png" alt="Mostly Clear" class="weather-icon">
                ...
                <div class="weather-details__today">
                    ...
                    <div class="weather-details__today__details">
                        ...
                        <div class="low-temp">
                            <!-- <svg aria-label="lowest temperature" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                <path d="M7.00185 11.6667L3.19252 8.102C2.94252 7.852 2.94252 7.44666 3.19252 7.19733C3.44252 6.94733 3.84719 6.94733 4.09719 7.19733L6.33519 9.43533L6.33519 0.333331L7.66919 0.333332L7.66919 9.43533L9.90719 7.19733C10.1572 6.94733 10.5625 6.94733 10.8125 7.19733C11.0625 7.44666 11.0625 7.852 10.8125 8.102L7.00185 11.6667ZM1.00002 13.6667C0.631831 13.6667 0.333355 13.3682 0.333355 13C0.333355 12.6318 0.631831 12.3333 1.00002 12.3333L13 12.3333C13.3682 12.3333 13.6667 12.6318 13.6667 13C13.6667 13.3682 13.3682 13.6667 13 13.6667L1.00002 13.6667Z">
                                </path>
                            </svg> -->
                                <span>
                                    <span class="weather__unit--metric" aria-label="24° celsius"><span aria-hidden="true">24°</span></span>
                                </span>
                        </div>
                        <div class="humidity"><svg aria-label="humidity" width="10" height="14" viewBox="0 0 10 14" fill="none" fill-rule="evenodd" clip-rule="evenodd"><path d="M4.57862 0.733744C4.37805 0.924318 0 5.4431 0 9C0 11.5764 2.05916 13.6667 5 13.6667C7.94055 13.6667 10 11.5788 10 9C10 5.55182 5.61738 0.932934 5.41653 0.738052L5 0.333336L4.57862 0.733744ZM5.23851 10.5159C4.92326 10.5212 4.67276 10.7523 4.67876 11.0323C4.68475 11.3091 4.93895 11.5296 5.24906 11.5296H5.26019C6.78339 11.5035 8.02272 10.3821 8.02272 9.02929C8.02272 8.58808 7.89119 8.15447 7.64242 7.7751C7.48351 7.53333 7.13402 7.45198 6.86185 7.59238C6.58967 7.73328 6.49752 8.04372 6.65615 8.28549C6.80336 8.51028 6.88153 8.76725 6.88153 9.02929C6.88153 9.8334 6.14432 10.5004 5.23851 10.5159Z"></path>
                                </svg>
                                <span>54%</span>
                        </div>
                    </div>
            ...
            <div class="weather-details__additional-info">
                ...
                <div class="flex-col">10 mi<span class="label">Visibility</span>
                </div>
            </div>
        </div>
        </div>
